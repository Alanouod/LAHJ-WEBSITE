...
urlpatterns = [
    ...
    path('projects/', views.projects, name='projects'),  # For accessing all projects
    path('projects/<int:professional_id>/', views.projects, name='professional_projects'),  # For accessing projects for a specific professional
